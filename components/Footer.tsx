...
const Footer = () => {
  return (
    <>
      <div className=" mt-[50px] w-full md:h-[50vh] bg-[#fffaf6] flex flex-col md:flex-row items-center justify-center pb-12 lg:pb-0 px-2 lg:px-0">
          ...
          <div className=" w-full">
            ...
            <div className=" w-full flex items-center justify-center border-b border-b-black">
              <input
                ...
                className=" bg-transparent text-black placeholder:text-black placeholder:text-sm py-2 w-full focus:outline-none"
              />
              <button>
                <ArrowForward />
              </button>
